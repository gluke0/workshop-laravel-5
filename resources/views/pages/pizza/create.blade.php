...
<form action=" {{ route('pizza.store') }} " method="POST" class="row">
    ...
    <div class="form-group mt-3">
        ...
        <input type="text" id="input-name" class="form-control @error('name') is-invalid @enderror" name="title" placeholder="pizza name" autofocus>
        @error('name')
    ...
    <div class="form-group mt-3 col-6">
        ...
        <input type="date" id="input-vegan" class="form-control" name="vegan"> 
    </div>
    <div class="form-group mt-3 col-6">
        <label for="input-available" class="form-label text-white">Available:</label>
        <input type="checkbox" id="input-available" name="available" placeholder="type">
    </div>
